        ...
        <q-form @submit="submit" v-if="!pedido.id">
          <div class="row">
            ...
            <div class="col-6 q-pa-xs">
              <q-btn label="CON FACTURA" :outline="facturaBtnBool" class="full-width" no-caps color="primary"
                     @click="facturaBtnBool = !facturaBtnBool"/>
            </div>
            <div class="col-6 q-pa-xs">
              <q-btn label="SIN FACTURA" :outline="sinfacturaBtnBool" class="full-width" no-caps color="primary"
                     @click="sinfacturaBtnBool = !sinfacturaBtnBool"/>
            </div>
            ...
            <div class="col-12">
              <q-input dense v-model="pedido.direccion" outlined label="Direccion"
                       :rules="[val => !!val || 'Este campo es requerido']"/>
            </div>
            <div class="col-12">
              <q-input dense v-model="pedido.contacto" outlined label="Contacto"
                       :rules="[val => !!val || 'Este campo es requerido']"/>
            </div>
            <div class="col-12">

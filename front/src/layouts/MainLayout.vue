  ...
  data () {
    return {
      ...
      linksList: [
        ...
        {title: 'reportes', icon: 'bar_chart', link: '/reportes', can: ['Administrador', 'Gerente', 'Ventas']},
        {title: 'Prospección', icon: 'local_offer', link: '/preventas', can: ['Administrador', 'Gerente', 'Ventas']},
        {title: 'Pedidos', icon: 'shopping_cart', link: '/pedidos', can: ['Administrador', 'Gerente', 'Ventas','Cobranza']},
        {title: 'Pagos', icon: 'attach_money', link: '/pagos', can: ['Administrador', 'Gerente', 'Ventas','Cobranza']},
        {title: 'Clientes', icon: 'groups', link: '/clientes', can: ['Administrador', 'Gerente', 'Ventas','Cobranza']},
        {title: 'Personal', icon: 'people_alt', link: '/ejecutivos', can: ['Administrador', 'Gerente','Cobranza']},
        {title: 'Productos', icon: 'category', link: '/productos', can: ['Administrador', 'Gerente']},
        {title: 'Cargos', icon: 'badge', link: '/cargos', can: ['Administrador', 'Gerente']},
        {title: 'Zonas', icon: 'place', link: '/zonas', can: ['Administrador', 'Gerente']},
        {title: 'Region', icon: 'public', link: '/regions', can: ['Administrador', 'Gerente']},
        {title: 'Servicios', icon: 'build', link: '/servicios', can: ['Administrador', 'Gerente','Cobranza']},
        {title: 'sueldos', icon: 'payments', link: '/sueldos', can: ['Administrador', 'Gerente','Cobranza']},
